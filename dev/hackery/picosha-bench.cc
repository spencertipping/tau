...
double measure_average_xxh64_hash_time(size_t num_trials = 1000000) {
...
int main() {
    ...
    double average_xxh_time = measure_average_xxh64_hash_time();

    std::cout << "Average time for SHA-256 hashing: " << average_sha_time << " microseconds" << std::endl;
    std::cout << "Average time for XXH64 hashing: " << average_xxh_time << " microseconds" << std::endl;
