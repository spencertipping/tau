...
struct Ωsr final : Ωtypes
{
  sletc HAS_BLOOM = 1ull << 40;

  Ωsr()      = default;
  Ωsr(Ωsrc&) = default;
  Ωsr(Sp<Ωf> f, u64 o) : f_(f), o_(o), n_(f_->get<u64b>(o_)) {}
  ...
  Ωhm    at         (u64)  const;  // lookup by index
  τ::u64 size       ()     const { return n_ & 0x0000'00ff'ffff'ffffull; }

  τ::u64 lsearch(Ωh, u64, u64) const;
  τ::u64 bsearch(Ωh, u64, u64) const;
  τ::u64 isearch(Ωh, u64, u64) const;


protected:
  Sp<Ωf> f_;  // backing file for this data
  u64    o_;  // offset of N within f_
  u64    n_;  // flags + number of h→m pairs
};
