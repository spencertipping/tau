...
template<> struct φauto_<i16> { static φ<i16> p() { return φm(πφwrap(πφint()), [](i64 x) { return i16(x); }); } };
template<> struct φauto_<i32> { static φ<i32> p() { return φm(πφwrap(πφint()), [](i64 x) { return i32(x); }); } };
