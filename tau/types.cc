...
St h_hex(h128 const &h) { return cppcodec::hex_lower::encode(h.data(), h.size()); }
...
St h_b64(h128 const &h) { return cppcodec::base64_rfc4648::encode(h.data(), h.size()); }
...
h128 h128_hex(Stc &s) { return from_vec<h128>(cppcodec::hex_lower::decode(s)); }
...
h128 h128_b64(Stc &s) { return from_vec<h128>(cppcodec::base64_rfc4648::decode(s)); }
