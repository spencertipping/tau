...
template<class I, class T = u8c*> inline constexpr I    R(T xs, uN i);
template<class I, class T = u8* > inline constexpr void W(T xs, uN i, I x);

template<class I, class T> inline constexpr typename std::enable_if<std::is_integral<I>::value and sizeof(I) == 1>::type R(T xs, uN i) { return                                        Sc<I>(xs[i]); }
template<class I, class T> inline constexpr typename std::enable_if<std::is_integral<I>::value and sizeof(I) == 2>::type R(T xs, uN i) { return Sc<I>(R<half<I>::type>(xs, i)) << 8  | R<half<I>::type>(xs, i + 1); }
template<class I, class T> inline constexpr typename std::enable_if<std::is_integral<I>::value and sizeof(I) == 4>::type R(T xs, uN i) { return Sc<I>(R<half<I>::type>(xs, i)) << 16 | R<half<I>::type>(xs, i + 2); }
template<class I, class T> inline constexpr typename std::enable_if<std::is_integral<I>::value and sizeof(I) == 8>::type R(T xs, uN i) { return Sc<I>(R<half<I>::type>(xs, i)) << 32 | R<half<I>::type>(xs, i + 4); }

template<class I, class T> inline constexpr typename std::enable_if<std::is_integral<I>::value and sizeof(I) == 1>::type W(T xs, uN i, I x) { xs[i] = x; }
template<class I, class T> inline constexpr typename std::enable_if<std::is_integral<I>::value and sizeof(I) == 2>::type W(T xs, uN i, I x) { W<half<I>::type>(xs, i, x >> 8);  W<half<I>::type>(xs, i + 1, x & 0xff); }
template<class I, class T> inline constexpr typename std::enable_if<std::is_integral<I>::value and sizeof(I) == 4>::type W(T xs, uN i, I x) { W<half<I>::type>(xs, i, x >> 16); W<half<I>::type>(xs, i + 2, x & 0xffff); }
template<class I, class T> inline constexpr typename std::enable_if<std::is_integral<I>::value and sizeof(I) == 8>::type W(T xs, uN i, I x) { W<half<I>::type>(xs, i, x >> 32); W<half<I>::type>(xs, i + 4, x & 0xffffffff); }

template<class I, class T> inline constexpr typename std::enable_if<std::is_same<I, f32>::value, f32>  R(T xs, uN i) { union {f32 f; i32 n;}; n = R<i32>(xs, i); return f; }
template<class I, class T> inline constexpr typename std::enable_if<std::is_same<I, f64>::value, f64>  R(T xs, uN i) { union {f64 f; i64 n;}; n = R<i64>(xs, i); return f; }

template<class I, class T> inline constexpr typename std::enable_if<std::is_same<I, f32>::value, void> W(T xs, uN i, f32 x) { union {f32 f; i32 n;}; f = x; I32(xs, i, n); }
template<class I, class T> inline constexpr typename std::enable_if<std::is_same<I, f64>::value, void> W(T xs, uN i, f64 x) { union {f64 f; i64 n;}; f = x; I64(xs, i, n); }
