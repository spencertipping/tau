...
## Next steps
1. Firm up binary spec for container indexes
2. Write bytecode verifier
3. Computation and indirection bytecodes
4. Document switching static allocator design (coupled to fiber switching)
5. GC?
6. Specify the hashing and collision strategy for symbols
7. Define transformation operation-space and bytecode
