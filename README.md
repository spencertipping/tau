...
## Next steps
1. Firm up lazy-op semantics, if present
2. Rewrite [m/records.md](m/records.md) and optionally [c/record.hh](c/record.hh)
3. Firm up binary spec for container indexes
4. Write bytecode verifier
5. Computation and indirection bytecodes
6. Document switching static allocator design (coupled to fiber switching)
7. GC?
8. Specify the hashing and collision strategy for symbols
9. Define transformation operation-space and bytecode
